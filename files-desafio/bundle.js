...
function resultado() {
  var chkReact = document.querySelector('#chkReact').checked;
  var chkVue = document.querySelector('#chkVue').checked;
  var chkAngular = document.querySelector('#chkAngular').checked;
  var disgrasa = [chkReact, chkVue, chkAngular];
}
